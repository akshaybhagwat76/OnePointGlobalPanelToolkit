...
namespace PickPackPic.API.Helpers
{
    ...
    public class ConstVal
    {
        ...
        public const string SocialProfileImage = "Social Image";
    }

    public class MailSubject
    {
        public const string Inquiry = "Inquiry Mail";
        public const string SignUpInquiry = "Sign Up Inquiry Mail";
        ...
        public const string RegistrationAccept = "Registration Request Accepted";
