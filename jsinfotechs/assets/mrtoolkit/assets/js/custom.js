...
//$('#GDPR_Consent_Given').click(function () {
//    $('.CheckboxErrormsg').hide();
//    $('#Given_for_Request_Only')[0].checked = false;
//    if ($('#GDPR_Consent_Given')[0].checked == true) {
//        $('#GDPR_Consent_Given')[0].checked = true;
//    } else {
//        $('#GDPR_Consent_Given')[0].checked = false;
//    }
//});

//$('#Given_for_Request_Only').click(function () {
//    $('.CheckboxErrormsg').hide();
//    $('#GDPR_Consent_Given')[0].checked = false;
//    if ($('#Given_for_Request_Only')[0].checked == true) {
//        $('#Given_for_Request_Only')[0].checked = true;
//    } else {
//        $('#Given_for_Request_Only')[0].checked = false;
//    }
//});
...
//	    var fcheckbox = $('#GDPR_Consent_Given')[0].checked;
//	    var scheckbox = $('#Given_for_Request_Only')[0].checked;
...
//	    if (fcheckbox == false && scheckbox == false) {
//	        if (!$('.CheckboxErrormsg').is(":visible")) {
//	            $('.CheckboxErrormsg').show();
//	        }
//	        IsValidate = false;
//	    } else {
//	        if ($('.CheckboxErrormsg').is(":visible")) {
...
//	    if (IsValidate) {
//	        fcheckbox = fcheckbox ? "Yes" : "No";
//	        scheckbox = scheckbox ? "Yes" : "No";
...
//	            companybody += "<p>Name: " + Customername + "</p><p>Email: " + fromemail + "</p><p>Mobile: " + mobNumber + "</p><p>Company: " + Companyname + "</p><p>Vistited from : mrtoolkit.onepointglobal.com</p>" + '<p>Full GDPR Consent Given: ' + fcheckbox + '</p>' + '<p>Consent Given for Request Only: ' + scheckbox + '</p><br/>';
...
//	                    var customerbody = "<p>Dear...</p><p>Thank you for your interest in the OnePoint Global Market Research Toolkit.</p>";
...
//$('#GDPR_Consent__Given').click(function () {
//    $('.CheckboxErrormsg1').hide();
//    $('#Given_for_Request__Only')[0].checked = false;
//    if ($('#GDPR_Consent__Given')[0].checked == true) {
//        $('#GDPR_Consent__Given')[0].checked = true;
//    } else {
//        $('#GDPR_Consent__Given')[0].checked = false;
//    }
//});

//$('#Given_for_Request__Only').click(function () {
//    $('.CheckboxErrormsg1').hide();
//    $('#GDPR_Consent__Given')[0].checked = false;
//    if ($('#Given_for_Request__Only')[0].checked == true) {
//        $('#Given_for_Request__Only')[0].checked = true;
//    } else {
//        $('#Given_for_Request__Only')[0].checked = false;
//    }
//});
...
//        var fcheckbox = $('#GDPR_Consent__Given')[0].checked;
//        var scheckbox = $('#Given_for_Request__Only')[0].checked;
//        //email validation regex expression
//        var regexExp = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;
//        var emailvlidate = regexExp.test(fromemail);
//        var apiUrl = "http://apidev.1pt.mobi/V3.0/Api/UserProfile/sendemail";
//        /*Validations for checkbox*/
//        if (fcheckbox == false && scheckbox == false) {
//            if (!$('.CheckboxErrormsg1').is(":visible")) {
//                $('.CheckboxErrormsg1').show();
//            }
//            IsValidate = false;
//        } else {
//            if ($('.CheckboxErrormsg1').is(":visible")) {
...
//                 companybody = "<p>Hi,</p><br/><p>A new request has been received from  Contact Us form. Here are the details: </p><br/>";
//                companybody += "<p>Name: " + Customername + "</p><p>Email: " + fromemail + "</p><p>Vistited from : mrtoolkit.onepointglobal.com</p>" + '<p>Full GDPR Consent Given: ' + fcheckbox + '</p>' + '<p>Consent Given for Request Only: ' + scheckbox + '</p><br/>';
...
//var is_safari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
//if (is_safari) {
//    document.getElementById("h1height").style.paddingTop = "150px";
